...
sleep 1s
### Restore Keys
$HERMES_BINARY -c ./network/hermes/config.toml keys restore agoric -p "m/44'/564'/0'/0/0" -m "record gift you once hip style during joke field prize dust unique length more pencil transfer quit train device arrive energy sort steak upset"
sleep 5s
